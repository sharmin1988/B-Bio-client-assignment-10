...
const Home = () => {
    return (
        <section style={{backgroundImage: 'url(https://img.freepik.com/free-vector/dna-genetic-biotechnology-science-vector-gray-neon-graphic_53876-126004.jpg?size=626&ext=jpg&ga=GA1.2.1239272833.1664376337&semt=sph)'}}  className=" text-gray-900 bg-cover mt-2 rounded-md">
