        ...
        <section>
            <div className="flex min-overflow-hidden">
                ...
                <div className="relative flex-1 hidden w-0 overflow-hidden lg:block">
                    <img className="absolute inset-0 object-cover w-full h-full" src="https://img.freepik.com/free-vector/sign-up-concept-illustration_114360-7885.jpg?w=740&t=st=1666702721~exp=1666703321~hmac=61d4177de8e783a2cb2c971e290a00b99fed280d98718560bfd5cbb6b5112da2" alt="" />
                </div>
            </div>
        </section>
    )
